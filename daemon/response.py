...
class Response():   
    ...
    def handle_text_other(self, sub_type = None):
        print(f"[Response] Handling other text subtype: {sub_type or 'unknown'}")
        return BASE_DIR + "othertype"
    def prepare_content_type(self, mime_type='text/html'):
        ...
        if not mime_type or '/' not in mime_type:
            raise ValueError("Invalid MIME type: {}".format(mime_type))
